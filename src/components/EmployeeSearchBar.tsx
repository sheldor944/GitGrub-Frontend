...
const formSchema = z.object({
  searchQuery: z.string({
    required_error: "Employee name or email is required",
  }),
});
...
const EmployeeSearchBar = ({ onSubmit, onReset, placeHolder, searchQuery }: Props) => {
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <Button type="submit" className="rounded-full bg-dark_color">
          Search
        </Button>
      </form>
    </Form>
